...
function Home() {
  ...
  const advantages = [
    ...
    },
    {
      ...
      description: 'AssetPilot handles all property management aspects, from maintenance to tenant relations.'
    }
  ];
  ...
  const investmentSteps = [
    {
      ...
      description: 'Connect your cryptocurrency wallet to AssetPilot to start investing.'
    },
    {
      icon: FaStore,
  ...
  const faqSections = [
    {
      ...
      questions: [
        {
          question: "What is AssetPilot?",
          answer: "AssetPilot is an innovative investment project dedicated to real estate. We allow clients to invest as little as $10 in investment properties, with the aim of building up regular income and/or savings."
        },
        {
        ...
        },
        {
          ...
          answer: "The AssetPilot Marketplace is our platform that allows AssetPilot community members to buy and sell NFTs among themselves.  It is the equivalent of a secondary market where investors can buy and sell NFTs among themselves. We may also cooperate with other marketplaces to allow anyone to choose their preferred marketplace."
        },
        {
        ...
        },
        {
          ...
          answer: "AssetPilot uses the most advanced technical means to ensure the confidentiality and security of transactions on the platform. "
        }
      ]
    }
  ];
    ...
    <div className="space-y-16">
      ...
      <section className="bg-secondary-900 text-white py-16">
        <div className="container">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold mb-4">How AssetPilot Works</h2>
      ...
      <section className="bg-secondary-50 pt-16">
        <div className="container">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold mb-4">Why Choose AssetPilot</h2>
          ...
          <div className="lg:grid lg:grid-cols-2 lg:gap-8 items-center">
            ...
            <div className="mt-12 lg:mt-0 flex justify-center">
              <div className="bg-white rounded-lg shadow-xl p-8 max-w-sm w-full">
                ...
                <a
                  href="https://discord.gg/AssetPilot"
                  target="_blank"
                ...
                <p className="mt-4 text-sm text-gray-500 text-center">
                  Already a member?{' '}
                  <a href="https://discord.gg/AssetPilot" className="text-indigo-600 hover:text-indigo-500">
                    Sign in
                  </a>
                </p>
              </div>
